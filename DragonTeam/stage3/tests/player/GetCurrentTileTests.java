...
public class GetCurrentTileTests {
	...
	@Test public void test00(){
		...
		AbstractTile before1 = gb.getTileFromTileNumber(16);
		AbstractTile before2 = p.getCurrentTile();
		p.moveToTile(26);
		AbstractTile after1 = gb.getTileFromTileNumber(26);
		AbstractTile after2 = p.getCurrentTile();
		assertTrue("",before1==before2 && after1==after2);
	}
