...
public class PopulateStaticMoveableTileArrayTests {
	
	@Test public void test00(){
		GameBoard gb = new GameBoard(4);
		gb.populateStaticMoveableTileArray(staticMoveableTileArray1());
		MoveableTile mt = gb.getMoveableTileArray().get(0);
		int etop = 0; int eright = 1; int eleft = 1; int ebottom = 0;
		int atop = mt.getTop();
		int aright = mt.getRight();
		int aleft = mt.getLeft();
		int abottom = mt.getBottom();
	...
	@Test public void test01(){
		GameBoard gb = new GameBoard(4);
		gb.populateStaticMoveableTileArray(staticMoveableTileArray1());
		MoveableTile mt = gb.getMoveableTileArray().get(4);
		int etop = 1; int eright = 0; int eleft = 1; int ebottom = 0;
		int atop = mt.getTop();
		int aright = mt.getRight();
		int aleft = mt.getLeft();
		int abottom = mt.getBottom();
